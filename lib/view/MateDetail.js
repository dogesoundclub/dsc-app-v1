...
class MateDetail extends react_1.Component {
    ...
    async componentDidMount() {
        this.setState({ name: await NameContract_1.default.getName(this.props.match.params.mateId) });
    }
    render() {
        ...
        return jsx_runtime_1.jsxs("main", Object.assign({ id: "matedetail" }, { children: [jsx_runtime_1.jsxs("div", Object.assign({ className: "menu-bar" }, { children: [jsx_runtime_1.jsx("h4", { children: "NFT" }, void 0),
                ...
                jsx_runtime_1.jsx("h3", { children: msg_js_1.default({
                        ko: `${this.state.name}에게 남겨진 메시지들`
                    }) }, void 0),
                jsx_runtime_1.jsx(MateMessageList_1.default, { mateId: mateId }, void 0)] }), void 0);
    }
}
