...
class Gallary extends react_1.Component {
    ...
    render() {
        return jsx_runtime_1.jsxs("main", Object.assign({ id: "gallary" }, { children: [jsx_runtime_1.jsxs("div", Object.assign({ className: "menu-bar" }, { children: [jsx_runtime_1.jsx("h4", { children: "Gallery" }, void 0),
                ...
                jsx_runtime_1.jsx(react_infinite_scroll_component_1.default, Object.assign({ className: "mate-list", dataLength: this.state.data.length / 8, next: this.loadMore, hasMore: this.state.data.length < 10000, loader: this.state.data.length === 0 ? jsx_runtime_1.jsx("p", { children: "Mate not exists." }, void 0) : jsx_runtime_1.jsx("p", { children: "Loading..." }, void 0), endMessage: jsx_runtime_1.jsx("p", { children: "Yay! You have seen it all" }, void 0) }, { children: this.state.data.map((data, index) => jsx_runtime_1.jsx(Mate_1.default, { mateId: data.id }, index)) }), void 0)] }), void 0);
    }
}
