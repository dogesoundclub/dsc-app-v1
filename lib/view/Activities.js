...
class Activities extends react_1.Component {
    render() {
        return jsx_runtime_1.jsxs("main", Object.assign({ id: "activities" }, { children: [jsx_runtime_1.jsxs("div", Object.assign({ className: "menu-bar" }, { children: [jsx_runtime_1.jsx("h4", { children: "Activities" }, void 0),
                ...
                jsx_runtime_1.jsxs("section", { children: [jsx_runtime_1.jsx("h2", { children: jsx_runtime_1.jsx("a", Object.assign({ href: "/activity/matename" }, { children: "NAME YOUR MATE" }), void 0) }, void 0),
                        jsx_runtime_1.jsx("p", { children: msg_js_1.default({
                                ko: "메이트에게 이름을 지어주세요. 메이트가 이름이 없다면, 가스비만을 지불하면 이름을 지어줄 수 있습니다. 하지만 변경을 하려면, 100 믹스를 지불해야 합니다. 다른 메이트와 똑같은 이름을 사용할 수 없습니다. 이름은 메이트 가격에 영향을 줄 수 있습니다."
                            }) }, void 0)] }, void 0),
                jsx_runtime_1.jsxs("section", { children: [jsx_runtime_1.jsx("h2", { children: jsx_runtime_1.jsx("a", Object.assign({ href: "/activity/matemessage" }, { children: "INDELIBLE DIARY" }), void 0) }, void 0),
                        jsx_runtime_1.jsx("p", { children: msg_js_1.default({
