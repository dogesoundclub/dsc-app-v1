...
class Layout extends react_1.Component {
    constructor(props) {
        super(props);
        this.clickMenuButtonHandler = () => {
            this.setState({ showingNav: this.state.showingNav !== true });
        };
        this.state = { showingNav: false };
    }
    render() {
        return jsx_runtime_1.jsxs(jsx_runtime_1.Fragment, { children: [jsx_runtime_1.jsxs("header", Object.assign({ className: this.state.showingNav === true ? "showing" : "hiding" }, { children: [jsx_runtime_1.jsx("a", Object.assign({ href: "/" }, { children: "HOME" }), void 0),
                        ...
                        jsx_runtime_1.jsx("a", Object.assign({ className: "ready", href: "/" }, { children: "BOARD" }), void 0),
