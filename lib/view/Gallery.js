...
class Gallery extends react_1.Component {
    constructor(props) {
        super(props);
        this.loadMore = () => {
    ...
    render() {
        return jsx_runtime_1.jsxs("main", Object.assign({ id: "gallery" }, { children: [jsx_runtime_1.jsxs("div", Object.assign({ className: "menu-bar" }, { children: [jsx_runtime_1.jsx("h4", { children: "Gallery" }, void 0),
