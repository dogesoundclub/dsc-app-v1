    ...
    render() {
        return jsx_runtime_1.jsxs("main", Object.assign({ id: "dogesound" }, { children: [jsx_runtime_1.jsxs("div", Object.assign({ className: "menu-bar" }, { children: [jsx_runtime_1.jsx("h4", { children: "Activities" }, void 0),
                ...
                jsx_runtime_1.jsxs("section", { children: [jsx_runtime_1.jsx("h2", { children: msg_js_1.default({
                        ...
                        Wallet_1.default.existsInjectedProvider === true && this.state.connected === false && jsx_runtime_1.jsx(jsx_runtime_1.Fragment, { children: msg_js_1.default({
                                ko: "카이카스에 로그인하세요.",
                            }) }, void 0),
                        Wallet_1.default.existsInjectedProvider === true && this.state.connected === true && jsx_runtime_1.jsx(RankList_1.default, {}, void 0)] }, void 0),
                jsx_runtime_1.jsxs("section", { children: [jsx_runtime_1.jsx("h2", { children: msg_js_1.default({
                                ko: "도지사운드 경연 현황판",
                        ...
                        Wallet_1.default.existsInjectedProvider === true && this.state.connected === true && jsx_runtime_1.jsx(DogeSoundContest_1.default, {}, void 0)] }, void 0)] }), void 0);
    }
}
