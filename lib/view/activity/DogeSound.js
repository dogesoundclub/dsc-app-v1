...
class DogeSound extends react_1.Component {
    render() {
        return jsx_runtime_1.jsxs("main", Object.assign({ id: "dogesound" }, { children: [jsx_runtime_1.jsx("img", { className: "top-image", src: "/images/dogesound.png" }, void 0),
                ...
                jsx_runtime_1.jsxs("section", { children: [jsx_runtime_1.jsx("h2", { children: msg_js_1.default({
                        ...
                        Wallet_1.default.existsInjectedProvider === undefined && jsx_runtime_1.jsx(jsx_runtime_1.Fragment, { children: msg_js_1.default({
                                ko: "클레이튼 네트워크를 찾을 수 없습니다. Kaikas를 설치해주시기 바랍니다.",
                            }) }, void 0),
                        Wallet_1.default.existsInjectedProvider !== undefined && jsx_runtime_1.jsx(RankList_1.default, {}, void 0)] }, void 0),
                jsx_runtime_1.jsxs("section", { children: [jsx_runtime_1.jsx("h2", { children: msg_js_1.default({
                                ko: "도지사운드 경연 현황판",
                            }) }, void 0),
                        Wallet_1.default.existsInjectedProvider === undefined && jsx_runtime_1.jsx(jsx_runtime_1.Fragment, { children: msg_js_1.default({
                        ...
                        Wallet_1.default.existsInjectedProvider !== undefined && jsx_runtime_1.jsx(DogeSoundContest_1.default, {}, void 0)] }, void 0),
