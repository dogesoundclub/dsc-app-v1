...
class NameForm extends react_1.Component {
    ...
    render() {
        return jsx_runtime_1.jsxs("div", Object.assign({ className: "name-form" }, { children: [jsx_runtime_1.jsx("input", { className: "mate-id", onChange: this.handleMateIdChange }, void 0),
