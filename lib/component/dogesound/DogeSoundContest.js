...
class DogeSoundContest extends react_1.Component {
    ...
    render() {
        return jsx_runtime_1.jsxs("div", Object.assign({ className: "doge-sound-contest" }, { children: [jsx_runtime_1.jsx(PeriodTriangle_1.default, { period: this.state.period }, void 0),
                this.state.period === SloganContract_1.default.HOLIDAY_PERIOD && jsx_runtime_1.jsxs("div", Object.assign({ className: "message" }, { children: [jsx_runtime_1.jsx("h4", { children: msg_js_1.default({
                ...
                this.state.period === SloganContract_1.default.REGISTER_CANDIDATE_PERIOD && jsx_runtime_1.jsxs("div", Object.assign({ className: "message" }, { children: [jsx_runtime_1.jsx("h4", { children: msg_js_1.default({
                ...
                this.state.period === SloganContract_1.default.VOTE_PERIOD && jsx_runtime_1.jsxs("div", Object.assign({ className: "message" }, { children: [jsx_runtime_1.jsx("h4", { children: msg_js_1.default({
                ...
                jsx_runtime_1.jsx(RegisterCandidateForm_1.default, {}, void 0),
                jsx_runtime_1.jsx(CandidateList_1.default, {}, void 0)] }), void 0);
    }
}
