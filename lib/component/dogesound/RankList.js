...
class RankList extends react_1.Component {
    ...
    render() {
        return jsx_runtime_1.jsxs("table", Object.assign({ className: "rank-list" }, { children: [jsx_runtime_1.jsx("thead", { children: jsx_runtime_1.jsxs("tr", { children: [jsx_runtime_1.jsx("th", Object.assign({ style: { width: "10%" } }, { children: "#" }), void 0),
