...
class RegisterCandidateForm extends react_1.Component {
    ...
    render() {
        return jsx_runtime_1.jsxs("div", { children: [msg_js_1.default({
                    ko: "도지사운드 후보 :",
                }),
                jsx_runtime_1.jsx("input", { value: this.state.slogan, onChange: this.handleSloganChange }, void 0),
                jsx_runtime_1.jsx("input", { value: this.state.count, onChange: this.handleCountChange }, void 0),
                msg_js_1.default({
                    ko: "개를 이용하여",
                }),
                jsx_runtime_1.jsx("a", Object.assign({ className: "register-candidate-form", onClick: this.register }, { children: msg_js_1.default({
                        ko: "제출하기",
                    }) }), void 0)] }, void 0);
    }
}
