...
class CandidateList extends react_1.Component {
    ...
    render() {
        return jsx_runtime_1.jsxs("div", Object.assign({ className: "candidate-list" }, { children: [jsx_runtime_1.jsx("p", { children: this.state.loaded === false ? msg_js_1.default({
                ...
                jsx_runtime_1.jsx("ul", { children: this.state.candidates.map((candidate, index) => jsx_runtime_1.jsxs("li", { children: [this.props.period === SloganContract_1.default.VOTE_PERIOD && jsx_runtime_1.jsx("input", { type: "radio", name: "candidate", value: index, checked: this.state.selectedCandidate === index, onChange: this.handleRadioCheck }, void 0),
