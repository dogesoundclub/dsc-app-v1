...
class Mate extends react_1.Component {
    ...
    async componentDidMount() {
        const count = (await NameContract_1.default.recordCount(this.props.mateId)).toNumber();
        if (count > 0) {
            const record = await NameContract_1.default.record(this.props.mateId, count - 1);
